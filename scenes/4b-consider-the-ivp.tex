...
%      \draw[->, >=stealth] (\xfo+\xf*\xd, 0) -- (\xf-\xfo, 0);
    ...
    \kftexttween[in=(\tc+\tdelay), duration=\dt, out=\tend+1, offset fst=0.7, offset snd=-pi/2]{0.5*\zunit}{0}{\scriptsize displacement}{0.5*\zunit}{0}{$f$}
    ...
    \kftexttween[in=(\td+\tdelay), duration=\dt, out=\te,  offset fst=0.8, offset snd=pi/2]{\zunit+\xvc/2}{0}{\scriptsize velocity}{\zunit+\xvc/2}{0}{$\frac{df}{dt}$}
    \kftextout[in=\te, out=(\te+\dt), offset fst=0.8, offset snd=pi/2]{\zunit+\xvc/2}{0}{$\frac{df}{dt}$}
