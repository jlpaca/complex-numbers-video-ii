\kfframes{9}{
  ...
  \begin{scope}[shift={({\halfwidth-3}, {\halfheight-2})}]
    ...
    \kftext[offset fst=0.7, offset snd=-pi/2]{0.5*\zunit}{0}{$f$}
    ...
    \kfclip{\tb}{\tend+1}{
      ...
      \kftextin[in=\tb+\dt, duration=\dt, out=\tc, polar=false]{\zunit/2+\xax}{-0.6+\xay}{$f$}
      \kftextout[in=\tc, out=\tc+\dt, polar=false]{\zunit/2+\xax}{-0.6+\xay}{$f$}
      
      \kftextin[in=\tc+\dt, out=\td, duration=\dt, polar=false]{\zunit/2+\xax}{0.6+\xay}{$c f$}
      \kftextout[in=\td, duration=\dt, out=\td+2*\dt, polar=false]{\zunit/2+\xax}{0.6+\xay}{$c f$}
      \kftextin[in=\td+\dt, out=\tend+1, duration=\dt, polar=false]{\zunit/2+\xax}{0.8+\xay}{$\frac{df}{dt}$}
    }
